...
class RegisterRequest extends FormRequest
{
    ...
    /**
     * Règles de validation pour la requête d'inscription
     * Ces règles s'exécutent AVANT que les données n'atteignent le contrôleur
     */
    public function rules(): array
    {
        return [
            ...
            'password' => [
                'required',
                'string',
                Password::defaults(), // Règles de sécurité Laravel
            ],
